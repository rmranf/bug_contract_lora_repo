...
PHASE1_DATA="${PHASE1_DATA:-$TRAIN_DIR/command_semantic_training_chat_with_loop_v1.jsonl}"
PHASE2_DATA="${PHASE2_DATA:-$TRAIN_DIR/command_semantic_training_chat_mixed_goldx10_with_loopx10_v1.jsonl}"

PHASE1_OUT="${PHASE1_OUT:-$TRAIN_DIR/lora_runs/command_semantic_phase1_warmup_with_loop}"
PHASE2_OUT="${PHASE2_OUT:-$TRAIN_DIR/lora_runs/command_semantic_phase2_mixed_with_loop}"

echo "[info] ROOT_DIR=$ROOT_DIR"
echo "[info] MODEL_PATH=$MODEL_PATH"
echo "[info] TRAIN_DIR=$TRAIN_DIR"
echo "[info] CUDA_DEVICE=$CUDA_DEVICE"
echo "[info] PHASE1_DATA=$PHASE1_DATA"
echo "[info] PHASE2_DATA=$PHASE2_DATA"
...
echo "[done] command-semantic loop-suppression LoRA warmup + mixed phase finished"
