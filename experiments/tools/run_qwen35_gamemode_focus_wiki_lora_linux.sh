...
PHASE1_DATA="${PHASE1_DATA:-$TRAIN_DIR/gamemode_focus_training_chat_with_wiki_v1.jsonl}"
PHASE2_DATA="${PHASE2_DATA:-$TRAIN_DIR/gamemode_focus_training_chat_loopx20_with_wiki_v1.jsonl}"

PHASE1_OUT="${PHASE1_OUT:-$TRAIN_DIR/lora_runs/gamemode_focus_wiki_phase1}"
PHASE2_OUT="${PHASE2_OUT:-$TRAIN_DIR/lora_runs/gamemode_focus_wiki_phase2_loopx20}"
...
echo "[done] gamemode-focus wiki-augmented LoRA phase1 + phase2 finished"
