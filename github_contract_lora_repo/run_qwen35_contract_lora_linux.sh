...
ROOT_DIR="${ROOT_DIR:-/home/suho/bugcraft}"
MODEL_PATH="${MODEL_PATH:-/home/suho/models/Qwen3.5-9B}"
TRAIN_DIR="${TRAIN_DIR:-$ROOT_DIR/experiments/results/tuning/qwen35_ours_lite_clean82_2026-04-06}"
VENV_DIR="${VENV_DIR:-$ROOT_DIR/.venv-contract-lora}"
PYTHON_BIN="${PYTHON_BIN:-python3}"
CUDA_DEVICE="${CUDA_DEVICE:-1}"

PHASE1_DATA="$TRAIN_DIR/execution_contract_training_chat_v1.jsonl"
PHASE2_DATA="$TRAIN_DIR/execution_contract_training_chat_mixed_goldx10_v1.jsonl"

PHASE1_OUT="$TRAIN_DIR/lora_runs/contract_phase1_warmup"
PHASE2_OUT="$TRAIN_DIR/lora_runs/contract_phase2_mixed"
...
echo "[done] contract-first LoRA warmup + mixed phase finished"
